...
SELECT
	...
	, CASE 
		...
		ELSE NULL 
        END																            AS tlb_order_early_pickup_time
	...
	, CASE 
		...
		ELSE NULL 
        END																            AS tlb_order_early_delivery_time
    ...
    , CONVERT(NVARCHAR, a.ORCAC)													AS tlb_order_customer_phone_area_code
    , CONVERT(NVARCHAR, a.ORCPHN)													AS tlb_order_customer_phone_number
    , CONVERT(NVARCHAR, a.ORRAC)													AS tlb_order_consignee_phone_area_code
    , CONVERT(NVARCHAR, a.ORRPHN)													AS tlb_order_consignee_phone_number
    ...
    --, TRIM(a.ORLD)																AS tlb_order_load_count --Redundancy for the last several years. 
	...
	, CASE 
		...
		ELSE NULL 
        END																            AS tlb_order_late_pickup_time
	...
	, CASE 
		...
		ELSE NULL 
        END																            AS tlb_order_late_delivery_time
	...
	, CASE 
		...
		ELSE NULL 
        END																            AS tlb_order_ship_time
	--, TRIM(a.ORSHTM)																AS tlb_order_ship_time
	...
	, CASE 
		...
		ELSE NULL 
        END																            AS tlb_order_last_update_time
