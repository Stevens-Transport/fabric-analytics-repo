/***************************************************************************************************
Procedure:          dbo.usp_ibmi_cd_order_silver
Create Date:        2024-08-22
Author:             Jeremy Shahan
Description:        Truncate and load of cd order to  Silver
Called by:          Fabric
					Pipeline: ibmi_cd_order
Affected table(s):  silver.ibmi_cd_order
Usage:              EXEC dbo.usp_ibmi_cd_order_silver
...
CREATE     PROCEDURE [dbo].[usp_ibmi_cd_order_silver]
AS

SET NOCOUNT ON

DELETE FROM silver.ibmi_cd_order

INSERT INTO silver.ibmi_cd_order
SELECT
